...
func (_q *APIKeyQuery) QueryRequests() *RequestQuery {
...
func (_q *APIKeyQuery) WithRequests(opts ...func(*RequestQuery)) *APIKeyQuery {
	query := (&RequestClient{config: _q.config}).Query()
...
func (_q *APIKeyQuery) prepareQuery(ctx context.Context) error {
	...
	if err := apikey.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *APIKeyQuery) loadRequests(ctx context.Context, query *RequestQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *Request)) error {
...
func (_q *APIKeyQuery) Modify(modifiers ...func(s *sql.Selector)) *APIKeySelect {
...
func (_q *APIKeyQuery) WithNamedRequests(name string, opts ...func(*RequestQuery)) *APIKeyQuery {
	query := (&RequestClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *APIKeySelect) Modify(modifiers ...func(s *sql.Selector)) *APIKeySelect {
