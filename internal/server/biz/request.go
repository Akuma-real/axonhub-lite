...
func NewRequestService(ent *ent.Client, systemService *SystemService, usageLogService *UsageLogService, liveStreamRegistry *LiveStreamRegistry) *RequestService {
